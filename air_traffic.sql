...
CREATE TABLE passengers (id SERIAL PRIMARY KEY, first_name TEXT NOT NULL, last_name TEXT NOT NULL, seat TEXT NULL, departure TIMESTAMP NULL, arrival TIMESTAMP NULL, airline INT NULL REFERENCES airlines, from_city INT NULL REFERENCES cities, from_country INT NULL REFERENCES countries, to_city INT NULL REFERENCES cities, to_country INT NULL REFERENCES countries);


INSERT INTO passengers(first_name, last_name, seat, departure, arrival, airline, from_city, from_country, to_city, to_country)
VALUES
